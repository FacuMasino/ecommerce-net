...
namespace DataAccessLayer
{
    ...
    public class DataAccess
    {
        ...
        public DataAccess()
        {
            _connectionString = ConfigurationManager.ConnectionStrings["docker_1"].ToString(); // Modificar en esta línea el argumento de ConnectionString["ana ó facu ó maxi"] para elegir la base de datos.
