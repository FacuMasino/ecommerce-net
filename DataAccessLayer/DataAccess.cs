...
namespace DataAccessLayer
{
    ...
    public class DataAccess
    {
        ...
        public DataAccess()
        {
            _connectionString = ConfigurationManager.ConnectionStrings["maxi_mac_1"].ToString(); // Modificar en esta línea el argumento de ConnectionString["ana ó facu ó maxi"] para elegir la base de datos.
