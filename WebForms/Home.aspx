...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    ...
    <div class="container">
        <div class="row py-5">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <asp:UpdatePanel
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="SearchPanel" CssClass="input-group mb-3" DefaultButton="SearchBtn" runat="server">
                                    <asp:TextBox
                                    ...
                                    <asp:LinkButton
                                        ...
                                        ID="SearchBtn"
                                        CssClass="btn btn-outline-primary rounded-end"
                                        ClientIDMode="Static"
                                        runat="server"
            ...
            <asp:UpdatePanel ID="ProductsUP" runat="server" class="col-md-9 col-12 mt-md-0 mt-3"
                UpdateMode="Conditional">
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="SearchBtn" />
                </Triggers>
