...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    ...
    <div class="container-fluid bg-body-tertiary">
        <%
            ...
            {
        %>
        <div class="d-flex container mt-auto flex-column align-items-center justify-content-center gap-4 my-5">
    ...
    <div class="container">
        <div class="d-flex flex-column my-5">
                        ...
                        <div class="col">
                            <div class="card shadow-sm shadow-hover">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-subtitle mb-0 mt-auto text-muted fw-bold">
                                        <%#Eval("Price", "{0:C}") %>
                                    </p>
            ...
            <div class="col-6 align-self-center text-center mt-3">
                <h5 class="fs-5 fw-normal">En este momento no tenemos productos similares, pero podemos
                    ofrecerte una amplia
