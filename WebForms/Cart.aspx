<%@ Page Title="Tu Carrito" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Cart.aspx.cs" Inherits="WebForms.Cart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    <div class="container">
        <div class="d-flex flex-column align-items-center py-4 my-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 d-flex flex-column justify-content-between py-2">
                                            <div class="d-flex flex-md-row flex-column mb-2 fw-bold">
                                                <a class="text-body text-decoration-none" href="Product.aspx?id=<%#Eval("id")%>"><%#Eval("brand")%>
                                                    - <%#Eval("name")%></a>
                                                <span class="text-muted ms-auto"><%# Eval("price", "{0:C}")%></span>
                                            </div>
                                            <p class="text-muted text-md-start text-end mb-md-auto mb-2">Subtotal <%# Eval("subtotal", "{0:C}")%>
                                            </p>
                                            <div class="d-inline-flex align-items-center justify-content-between w-100">
                                                <div class="itemcount bg-body-tertiary">
                                                    <asp:LinkButton Text='<i class="bi bi-dash"></i>' CssClass="itemcount-control minus bg-body-tertiary text-decoration-none text-black fs-5 px-2"
                                                        CommandArgument='<%#Eval("Id")%>' ID="removeLnkButton" OnClick="removeLnkButton_Click"
                                                        runat="server" />
                                                    <input type="number" class="itemcount-control bg-body-tertiary" value="<%#Eval("quantity") %>"
                                                        disabled>
                                                    <asp:LinkButton Text='<i class="bi bi-plus"></i>' CssClass="itemcount-control plus bg-body-tertiary text-decoration-none text-black fs-5 px-2"
                                                        CommandArgument='<%#Eval("Id")%>' ID="addLnkButton" OnClick="addLnkButton_Click"
                                                        runat="server" />
                                                </div>
                                                <asp:LinkButton Text="X Eliminar" CssClass="text-muted text-decoration-none" CommandArgument='<%#Eval("Id")%>'
                                                    ID="deleteLnkButton" OnClick="deleteLnkButton_Click" runat="server" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="col-md-4 col-12">
                    <div class="p-4 mb-4 bg-body-tertiary">
                        <ul class="list-group custom-list-group list-group-sm list-group-flush bg-body-tertiary">
                            ...
                            <li class="list-group-item fs-sm text-center text-gray-500 bg-transparent">Costos de
                                envío calculados al momento del pago *
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-6">
                <h5 class="text-align-center">Todavía no agregaste ningún artículo a tu carrito...
                </h5>
